...
export default function AIAdvice({ scanResult, onNav }) {
  ...
  if (!scanResult?.findings?.length) {
    return (
      <div style={{ padding: '32px 40px', animation: 'fade-up 0.3s ease' }}>
        ...
        <h1 style={{ fontSize: 28, fontWeight: 600, color: 'var(--text-primary)', marginBottom: 24 }}>AI remediation advice</h1>
  ...
  return (
    <div style={{ padding: '32px 40px', overflow: 'auto', animation: 'fade-up 0.3s ease' }}>
      ...
      <p style={{ color: 'var(--text-secondary)', fontSize: 14, marginBottom: 24 }}>Gemini-powered explanations and step-by-step remediation for your scan findings.</p>
